...
export default function Tvshows() {
  ...
  async function getTrending(pageNumber){
    let {data} = await axios.get(`https://api.themoviedb.org/3/discover/tv?api_key=eba8b9a7199efdcb0ca1f96879b83c44&fbclid=IwAR329J3L4o5HCBdmnRtb10khNGNAOGU2pIbRWIo4PNniuCHsK-cMpvZhSfc&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=${pageNumber}`);
  ...
  return (
    <>
      <section id="shows" className="py-5">
          ...
          <div className="row py-5">
            ...
            {trendingTv.map((tv, i)=> <div key={i} className='col-md-2'>
                <div className="movie">
                  ...
                  <span className="rate">{tv.vote_average}</span>
                </div>
            </div>)}
          </div>
